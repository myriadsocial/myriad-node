...
use sp_core::{
	...
	Decode, Encode, OpaqueMetadata, H160, H256, U256,
};
...
pub mod currency {
	...
	pub const MYRIA: Balance = 1_000_000_000_000_000_000;
	pub const KILOMYRIA: Balance = MYRIA * 1_000;
	pub const MILLIMYRIA: Balance = MYRIA / 1_000;
	pub const MICROMYRIA: Balance = MILLIMYRIA / 1_000;
	pub const NANOMYRIA: Balance = MICROMYRIA / 1_000;
...
impl pallet_session::Config for Runtime {
	...
	type WeightInfo = pallet_session::weights::SubstrateWeight<Runtime>; // TODO: change this for dynamic fee
}
...
parameter_types! {
	pub const AssetDeposit: Balance = 100 * currency::MYRIA;
	pub const ApprovalDeposit: Balance = currency::MYRIA;
	pub const StringLimit: u32 = 50;
	pub const MetadataDepositBase: Balance = 10 * currency::MYRIA;
	pub const MetadataDepositPerByte: Balance = currency::MYRIA;
}
...
pub struct MyriadGasWeightMapping;

impl pallet_evm::GasWeightMapping for MyriadGasWeightMapping {
...
impl pallet_evm::Config for Runtime {
	...
	type GasWeightMapping = MyriadGasWeightMapping;
